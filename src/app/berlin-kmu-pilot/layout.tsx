...
export const metadata: Metadata = {
  title: 'KMU Pentest Berlin – Cybersecurity für kleine und mittlere Unternehmen | SODU Secure',
  description: 'Professioneller Pentest in Berlin für KMUs. Externer Pentest, Active Directory Analyse, Phishing-Simulation. Jetzt bezahlte Pentests für KMUs – Erfahren Sie mehr!',
  keywords: [
    'Pentest Berlin',
    'Pentest KMU',
    'Pentest Berlin KMU',
  ...
  openGraph: {
    title: 'KMU Pentest Berlin – Cybersecurity für KMUs | SODU Secure',
  ...
  twitter: {
    ...
    title: 'KMU Pentest Berlin – Cybersecurity für KMUs | SODU Secure',
    description: 'Professioneller Pentest in Berlin für KMUs.',
  },
  alternates: {
