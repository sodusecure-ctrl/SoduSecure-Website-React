    ...
    <main className="bg-[#0A0A0B] text-white min-h-screen">
      ...
      <section className="relative overflow-hidden bg-[#0A0A0B] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-16 sm:px-6 sm:pt-14 sm:pb-20 lg:pt-20 lg:pb-24">
          ...
          <h1 className="mt-8 max-w-5xl text-[34px] font-semibold leading-[1.08] tracking-[-0.03em] [text-wrap:balance] sm:text-[44px] sm:leading-[1.04] md:text-6xl lg:text-7xl">
            <span className="premium-silver">Penetrationstest &amp; Pentesting –</span>
            <br />
            <span className="premium-headline-accent">Manuell. Methodisch.</span>
            <br />
            <span className="premium-silver">Wirkungsvoll.</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">
              ...
              <span className="text-[#FF3B30]">Penetration Testing – erklärt</span>
            </h2>
                ...
                <div key={row.label}
                  ...
                  <div className="flex gap-6">
                    <div className="flex items-center gap-1 w-16 justify-center">
                      {row.pentest ? <CheckCircle className="w-4 h-4 text-green-400" /> : <span className="w-4 h-4 flex items-center justify-center text-white/70">✕</span>}
                    </div>
                    <div className="flex items-center gap-1 w-16 justify-center">
                      {row.scan ? <CheckCircle className="w-4 h-4 text-green-400" /> : <span className="w-4 h-4 flex items-center justify-center text-white/70">✕</span>}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {PENTEST_TYPES.map((svc) => (
              <Link key={svc.title} href={svc.href}
                className="group bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:border-[#FF3B30]/30 transition-all duration-200 hover:bg-white/[0.05]">
                <div className={`inline-flex items-center justify-center w-11 h-11 rounded-xl border mb-4 ${colorMap[svc.color]}`}>
                  <svc.icon className="w-5 h-5" />
                </div>
                <h3 className="font-semibold text-white mb-2 group-hover:text-[#FF6B61] transition-colors">{svc.title}</h3>
          ...
          <div className="mt-10 bg-gradient-to-r from-red-950/30 to-orange-950/20 border border-[#FF3B30]/20 rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <Link href="/request-pentest"
                className="inline-flex items-center gap-2 bg-[#FF3B30] hover:bg-[#FF3B30] text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105 flex-shrink-0">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {PHASES.map((p) => (
            <div key={p.step} className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
              <div className="text-5xl font-black text-[#FF3B30]/20 mb-3 leading-none">{p.step}</div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={c.name} className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 flex flex-col">
                ...
                <p className="text-white/60 text-sm leading-relaxed flex-1 mb-3">{c.desc}</p>
      ...
      <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-red-950/40 via-[#0A0A0B] to-orange-950/30 border border-[#FF3B30]/25 rounded-2xl p-8 text-center">
          ...
          <p className="mt-4 text-xs text-white/70">Keine Verpflichtung · Festpreis garantiert · Angebot in 24h</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <Link key={item.href} href={item.href}
                ...
                <h3 className="font-semibold text-white text-sm mb-2 group-hover:text-[#FF3B30] transition-colors">{item.title}</h3>
