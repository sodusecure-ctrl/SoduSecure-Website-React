    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center sm:p-8 p-0 bg-white">
        <div className="w-full max-w-lg shadow-sm border border-gray-100 sm:p-10 p-4 rounded-xl">
          ...
          <p className="text-center text-gray-600 text-sm mb-2">{t('welcomeBack')}</p>
          <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">{t('signIn')}</h1>
          ...
          <div className="space-y-5" onKeyPress={handleKeyPress}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between space-x-2">
                ...
                <Link href="/auth/forgot-password" className='text-sm text-gray-600 hover:underline cursor-pointer'>{t('forgotPassword')}</Link>
              </div>
              {termsError && (
            ...
            >
              {t('signInButton')} <ArrowRight className="ml-2" size={20} />
            </Button>
