...
export default function SignUpForm() {
  ...
  const validateField = (name: keyof FormData, value: string): string => {
    switch (name) {
      case 'fullName':
        return value.trim() === '' ? t('validation.fullNameRequired') : '';
      case 'email':
      ...
      case 'confirmPassword':
        ...
        if (value !== formData.password) return t('validation.passwordsDoNotMatch');
        return '';
      default:
        return '';
    }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center sm:p-8 p-0 bg-white">
        <div className="w-full max-w-lg shadow-sm border border-gray-100 sm:p-10 p-4 rounded-xl">
          ...
          <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">{t('title')}</h1>
          ...
          <div className="space-y-5" onKeyPress={handleKeyPress}>
            ...
            >
              {t('signUpButton')} <ArrowRight className="ml-2" size={20} />
            </Button>
