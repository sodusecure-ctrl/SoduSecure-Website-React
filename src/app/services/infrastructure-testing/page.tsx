...
export default function InfraPentestLanding() {
  ...
  const t = useTranslations('infrastructureTesting');

  const includedItems = [
    { icon: Network, text: t('whatsIncluded.items.0') },
    { icon: Shield, text: t('whatsIncluded.items.1') },
    { icon: Server, text: t('whatsIncluded.items.2') },
    { icon: Lock, text: t('whatsIncluded.items.3') },
    { icon: Wifi, text: t('whatsIncluded.items.4') },
    { icon: Network, text: t('whatsIncluded.items.5') },
    { icon: Database, text: t('whatsIncluded.items.6') },
    { icon: Database, text: t('whatsIncluded.items.7') }
  ];

  const scopeItems = [
    { icon: Database, title: t('scopeCoverage.items.activeDirectory.title'), desc: t('scopeCoverage.items.activeDirectory.description') },
    { icon: Network, title: t('scopeCoverage.items.networkDevices.title'), desc: t('scopeCoverage.items.networkDevices.description') },
    { icon: Server, title: t('scopeCoverage.items.servers.title'), desc: t('scopeCoverage.items.servers.description') },
    { icon: Lock, title: t('scopeCoverage.items.vpnRdp.title'), desc: t('scopeCoverage.items.vpnRdp.description') },
    { icon: Network, title: t('scopeCoverage.items.workstations.title'), desc: t('scopeCoverage.items.workstations.description') },
    { icon: Wifi, title: t('scopeCoverage.items.wirelessNetworks.title'), desc: t('scopeCoverage.items.wirelessNetworks.description') },
    { icon: Settings, title: t('scopeCoverage.items.configuration.title'), desc: t('scopeCoverage.items.configuration.description') },
    { icon: Shield, title: t('scopeCoverage.items.securityControls.title'), desc: t('scopeCoverage.items.securityControls.description') }
  ];
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {deliverables.map((item, index) => (
              <Card key={index} className="border-2 border-white/10 hover:border-red-600 transition-colors h-full">
                <CardContent className="p-4 sm:p-6">
