...
export default function MobileAppPentestLanding() {
  const router = useRouter();
  const t = useTranslations('mobileAppTesting');
  const includedItems = [
  ...
  const scopeItems = [
    { icon: Database, title: t('scopeCoverage.items.storageSecurity.title'), desc: t('scopeCoverage.items.storageSecurity.description') },
    { icon: Lock, title: t('scopeCoverage.items.authentication.title'), desc: t('scopeCoverage.items.authentication.description') },
    { icon: Wifi, title: t('scopeCoverage.items.networkTraffic.title'), desc: t('scopeCoverage.items.networkTraffic.description') },
    { icon: Code, title: t('scopeCoverage.items.reverseEngineering.title'), desc: t('scopeCoverage.items.reverseEngineering.description') },
    { icon: FileCode, title: t('scopeCoverage.items.backendApis.title'), desc: t('scopeCoverage.items.backendApis.description') },
    { icon: Key, title: t('scopeCoverage.items.cryptography.title'), desc: t('scopeCoverage.items.cryptography.description') },
    { icon: Shield, title: t('scopeCoverage.items.permissions.title'), desc: t('scopeCoverage.items.permissions.description') },
    { icon: Smartphone, title: t('scopeCoverage.items.platformSecurity.title'), desc: t('scopeCoverage.items.platformSecurity.description') }
  ];
      ...
      <section className="relative overflow-hidden bg-[#0A0A0B] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-16 sm:px-6 sm:pt-14 sm:pb-20 lg:pt-20 lg:pb-24">
          <div className="flex items-center gap-2 text-[12px] font-medium tracking-[0.04em] text-white/65">
            ...
            <Smartphone className="h-3.5 w-3.5 text-[#FF3B30]" />
          </div>
