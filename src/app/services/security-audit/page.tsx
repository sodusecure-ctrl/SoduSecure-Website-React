...
export default function SecurityAuditLanding() {
  ...
  const scopeItems = [
    { icon: Shield, title: t('scopeCoverage.items.comprehensiveAssessment.title'), desc: t('scopeCoverage.items.comprehensiveAssessment.description') },
    { icon: Target, title: t('scopeCoverage.items.multipleMethodologies.title'), desc: t('scopeCoverage.items.multipleMethodologies.description') },
    { icon: BarChart3, title: t('scopeCoverage.items.riskPrioritization.title'), desc: t('scopeCoverage.items.riskPrioritization.description') },
    { icon: CheckCircle, title: t('scopeCoverage.items.complianceAlignment.title'), desc: t('scopeCoverage.items.complianceAlignment.description') },
    { icon: Settings, title: t('scopeCoverage.items.remediationGuidance.title'), desc: t('scopeCoverage.items.remediationGuidance.description') },
    { icon: Users, title: t('scopeCoverage.items.executiveReporting.title'), desc: t('scopeCoverage.items.executiveReporting.description') },
    { icon: FileText, title: t('scopeCoverage.items.technicalDetails.title'), desc: t('scopeCoverage.items.technicalDetails.description') },
    { icon: List, title: t('scopeCoverage.items.followUpSupport.title'), desc: t('scopeCoverage.items.followUpSupport.description') }
  ];
