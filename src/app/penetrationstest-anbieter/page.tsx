      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Welche Zertifizierungen zeigen echte Kompetenz?</p>
          </div>
            ...
            {CERTIFICATIONS.map((cert) => {
              ...
              return (
                <div key={cert.name} className={`border rounded-xl p-5 ${colorClasses}`}>
                  ...
                  <div className="text-xs text-gray-400 mb-3">{cert.org}</div>
                  <p className="text-gray-400 text-xs leading-relaxed mb-3">{cert.desc}</p>
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Wie man einen seriösen Pentester von einem unseriösen unterscheidet.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {WHAT_TO_LOOK_FOR.map((item, i) => {
              const Icon = item.icon;
              return (
                <div key={i} className="flex gap-4 bg-[#131927] border border-gray-800 rounded-xl p-5">
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Warnsignale für unseriöse Pentester.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {RED_FLAGS.map((flag, i) => {
              const Icon = flag.icon;
              return (
                <div key={i} className="flex gap-3 bg-red-600/5 border border-red-600/20 rounded-xl p-5">
                  <Icon className="w-6 h-6 text-red-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-red-400 mb-1">{flag.title}</h3>
                    <p className="text-gray-400 text-sm">{flag.desc}</p>
                  </div>
                </div>
              );
            })}
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Warum wir der Partner für seriöse Sicherheit sind.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {OUR_STRENGTHS.map((strength) => {
              const Icon = strength.icon;
              return (
                <div key={strength.title} className="flex gap-4 bg-[#131927] border border-gray-800 rounded-xl p-6">
                  <div className="w-10 h-10 bg-purple-600/10 border border-purple-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon className="w-5 h-5 text-purple-400" />
                  </div>
                  <div>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Welche Pentest ist für wen geeignet?</p>
          </div>
