    ...
    <main className="bg-[#0A0A0B] text-white min-h-screen">
      ...
      <section className="premium-hero py-20 lg:py-32 border-b border-white/10">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="inline-flex items-center gap-2 bg-[#FF3B30]/10 border border-[#FF3B30]/20 rounded-full px-4 py-1.5 mb-6">
            <MailIcon className="w-4 h-4 text-[#FF3B30]" />
            <span className="text-[#FF3B30] text-sm font-medium">NIS2 · ISO 27001 · DSGVO-konform</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Phishing Simulation –<br />
            <span className="text-[#FF3B30]">Mitarbeiter wirklich testen</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14">
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 premium-cta text-white px-8 py-4 rounded-2xl font-semibold transition-colors text-base">
              Phishing Simulation anfragen <ArrowRight className="w-5 h-5" />
            </Link>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {STATS.map((s) => (
              <div key={s.stat} className="bg-[#0A0A0B] border border-white/10 rounded-xl p-4 text-center">
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">Von der klassischen Phishing-E-Mail bis zu fortgeschrittenen MFA-Bypass-Angriffen – wir simulieren alle relevanten Angriffsvektoren.</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-red-900/20 via-[#0A0A0B] to-[#0A0A0B] border-t border-white/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/60 text-lg mb-8">Kostenlose Erstberatung · Festpreisangebot in 24h · DSGVO-konform</p>
