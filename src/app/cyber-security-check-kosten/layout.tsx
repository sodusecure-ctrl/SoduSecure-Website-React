...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Cyber Security Check Kosten | SODU Secure', description: 'Transparente Preise für IT-Sicherheitschecks. Festpreisangebot in 24 Stunden.', url: `${baseUrl}/cyber-security-check-kosten`, type: 'website', siteName: 'Penetration Testing | Dein Zertifizierter IT Spezialist', images: [{ url: `${baseUrl}/images/blogs/image9.png`, width: 1200, height: 630, alt: 'Cyber Security Check Kosten' }] },
