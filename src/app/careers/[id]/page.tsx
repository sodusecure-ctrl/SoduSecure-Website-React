      ...
      <div className="py-6 sm:py-8 lg:py-12 px-4 sm:px-6">
        <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8 lg:space-y-10">
              ...
              <ul className="space-y-2.5 sm:space-y-3">
                {responsibilities.map((item, index) => (
                  <li key={index} className="flex items-start gap-2.5 sm:gap-3">
                    <span className="text-[#FF3B30] mt-1.5 sm:mt-2 flex-shrink-0 text-lg">•</span>
            ...
            {/* About Company */}
            <section className="bg-gray-50 border border-white/10 rounded-lg p-4 sm:p-6 lg:p-8">
            ...
            <div className="lg:hidden bg-red-600 text-white rounded-lg p-6">
              ...
              <a 
                ...
                className="block w-full bg-[#16141A] text-[#FF3B30] hover:bg-white/10 font-semibold py-6 text-base rounded-lg text-center transition-colors"
              >
                info@sodusecure.com
              </a>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-6 space-y-4 sm:space-y-6">
              ...
              <div className="bg-red-600 text-white p-4 sm:p-6 lg:p-8 rounded-lg">
                ...
                <a 
                  href="mailto:info@sodusecure.com"
                  className="block w-full bg-[#16141A] text-[#FF3B30] hover:bg-white/10 font-semibold py-4 sm:py-6 text-sm sm:text-base rounded-lg text-center transition-colors"
                >
                  info@sodusecure.com
                </a>
              </div>
              ...
              {/* Quick Information */}
              <div className="bg-[#16141A] border border-white/10 rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              <div className="hidden sm:block bg-[#16141A] border border-white/10 rounded-lg p-4 sm:p-6">
                <h3 className="text-lg font-bold mb-3 sm:mb-4">Share this Job</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                  <button className="w-full justify-center text-xs sm:text-sm border border-white/12 rounded-lg px-4 py-2 hover:bg-white/5 transition-colors">
                    LinkedIn
                  </button>
                  <button className="w-full justify-center text-xs sm:text-sm border border-white/12 rounded-lg px-4 py-2 hover:bg-white/5 transition-colors">
                    Twitter
              ...
              <div className="bg-gray-50 border border-white/10 rounded-lg p-4 sm:p-6">
                ...
                <a
                  href="mailto:info@sodusecure.com"
                  className="text-[#FF3B30] hover:text-[#FF6B61] text-sm sm:text-base font-medium"
                >
                  info@sodusecure.com
                </a>
              </div>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#16141A] border-t border-white/10 p-4 shadow-lg">
        <div className="container mx-auto max-w-7xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <a 
              href="mailto:info@sodusecure.com"
              className="bg-red-600 hover:premium-cta text-white font-semibold px-6 py-3 text-sm rounded-lg transition-colors"
            >
              Bewerben
            </a>
          </div>
