...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Cyber Security Check Preis – Preisliste | SODU Secure', description: 'Aktuelle Preise für Cyber Security Checks. Festpreisangebote vom zertifizierten Experten.', url: `${baseUrl}/cyber-security-check-preis`, type: 'website', siteName: 'Penetration Testing | Dein Zertifizierter IT Spezialist', images: [{ url: `${baseUrl}/images/blogs/image9.png`, width: 1200, height: 630, alt: 'Cyber Security Check Preis' }] },
