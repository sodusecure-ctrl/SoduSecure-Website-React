...
export default function Layout({ children }: { children: React.ReactNode }) {
  const jsonLd = { '@context': 'https://schema.org', '@type': 'ProfessionalService', name: 'SODU Secure – Cyber Security Check Preis', url: `${baseUrl}/cyber-security-check-preis`, logo: `${baseUrl}/icons/logo.png`, address: { '@type': 'PostalAddress', addressLocality: 'Berlin', addressCountry: 'DE' }, telephone: '+49-179-239-6294', email: 'sodusecure@gmail.com', priceRange: '€€' };
