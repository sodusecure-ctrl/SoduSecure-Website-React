...
const AUDIT_TYPEN = [
  ...
  { title: "Vollständiger Cybersecurity Audit", desc: "Kombination aller Bereiche – Web, Netzwerk, AD, Cloud und Compliance in einem Projekt.", badge: "Enterprise", color: "text-[#FF3B30]", bg: "bg-[#FF3B30]/10 border-[#FF3B30]/20" },
];
      ...
      <section className="relative overflow-hidden bg-[#0A0A0B] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-16 sm:px-6 sm:pt-14 sm:pb-20 lg:pt-20 lg:pb-24">
          ...
          <h1 className="mt-8 max-w-5xl text-[34px] font-semibold leading-[1.08] tracking-[-0.03em] [text-wrap:balance] sm:text-[44px] sm:leading-[1.04] md:text-6xl lg:text-7xl">
            <span className="premium-silver">Cybersecurity Audit –</span>
            <br />
      ...
      <section className="py-20 bg-white/[0.02] border-y border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Award, title: "OSCP & CEH-zertifiziert", desc: "Höchste anerkannte Pentest-Zertifizierungen – kein Scan-Reselling, echte Expertise.", color: "text-[#FF3B30]", bg: "bg-[#FF3B30]/10 border-[#FF3B30]/20" },
