...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: { path: string; lastModified: string; changeFreq: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }[] = [
    ...
    { path: '/penetration-testing-service',   lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 1.0  },
    { path: '/penetration-testing',           lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 1.0  },
    { path: '/pentesting-service',            lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 1.0  },
    { path: '/pentest-angebot',               lastModified: '2026-03-03', changeFreq: 'monthly', priority: 0.95 },
    { path: '/pentest-certification',         lastModified: '2026-03-03', changeFreq: 'monthly', priority: 0.9  },
    { path: '/penetration-testing-anbieter',  lastModified: '2026-03-03', changeFreq: 'monthly', priority: 0.95 },
    { path: '/it-sicherheitscheck',           lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 0.95 },
    { path: '/cybersecurity-audit',           lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 0.95 },
    { path: '/hacker-simulation',             lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 0.95 },
    { path: '/it-sicherheit-testen',          lastModified: '2026-03-03', changeFreq: 'weekly',  priority: 0.95 },
    { path: '/schwachstellenanalyse',         lastModified: '2026-03-03', changeFreq: 'monthly', priority: 0.9  },
    { path: '/sicherheitsaudit',              lastModified: '2026-03-03', changeFreq: 'monthly', priority: 0.9  },
    ...
    { path: '/case-studies',       lastModified: '2026-03-01', changeFreq: 'weekly',  priority: 0.85  },
