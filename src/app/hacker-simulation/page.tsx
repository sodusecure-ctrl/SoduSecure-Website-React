...
const ANGRIFFSVEKTOREN = [
  { icon: Eye, title: "Phishing & Social Engineering", desc: "Realistische Phishing-Kampagnen – vom spear-phishing bis zur CEO-Fraud-Simulation. Schult Awareness und testet technische Schutzmechanismen.", color: "text-[#FF3B30]", bg: "bg-[#FF3B30]/10 border-[#FF3B30]/20" },
      ...
      <section className="relative overflow-hidden bg-[#0A0A0B] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-16 sm:px-6 sm:pt-14 sm:pb-20 lg:pt-20 lg:pb-24">
          ...
          <h1 className="mt-8 max-w-5xl text-[34px] font-semibold leading-[1.08] tracking-[-0.03em] [text-wrap:balance] sm:text-[44px] sm:leading-[1.04] md:text-6xl lg:text-7xl">
            <span className="premium-silver">Hacker Simulation –</span>
            <br />
      ...
      <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            ...
            <span className="text-[#FF3B30]">automatisierter Scan</span>
          </h2>
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden">
          <div className="grid grid-cols-3 text-xs font-semibold text-white/60 uppercase tracking-wider px-6 py-3 bg-white/[0.03] border-b border-white/10">
            <span>Kriterium</span>
            <span className="text-[#FF3B30]">Hacker Simulation</span>
            <span>Auto. Scan</span>
          </div>
          {UNTERSCHIED.map((row, i) => (
            <div key={i} className={`grid grid-cols-3 px-6 py-4 text-sm border-b border-white/5 last:border-0 ${i % 2 === 0 ? '' : 'bg-white/[0.01]'}`}>
              <span className="text-white/60 text-xs">{row.aspect}</span>
              <span className="text-white/85 text-xs">{row.simulation}</span>
              <span className="text-white/50 text-xs">{row.scan}</span>
            </div>
          ))}
        </div>
      ...
      <section className="py-20 bg-white/[0.02] border-y border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-4">
                    <div className="inline-flex items-center justify-center w-8 h-8 bg-[#FF3B30]/10 border border-[#FF3B30]/20 rounded-2xl flex-shrink-0">
                      <item.icon className="w-4 h-4 text-[#FF3B30]" />
                    </div>
                    <div>
            ...
            <div className="bg-white/[0.03] border border-[#FF3B30]/20 rounded-2xl p-8 text-center">
              <div className="text-4xl font-bold text-[#FF3B30] mb-2">85 %</div>
