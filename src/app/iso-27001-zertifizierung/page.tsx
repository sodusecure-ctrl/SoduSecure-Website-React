...
export default function ISO27001CertificationPage() {
  ...
  return (
    <main className="bg-[#0d1117] text-white min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#131927] via-[#0d1117] to-[#131927] py-20 lg:py-32 border-b border-gray-800 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/request-pentest" className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors text-base">
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Von der Analyse zum Zertifikat – unser bewährter Prozess.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TIMELINE.map((phase, i) => {
              const Icon = phase.icon;
              return (
                <div key={i} className="bg-[#131927] border border-gray-800 rounded-xl p-6 hover:border-green-600/30 transition-colors">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 bg-green-600/10 border border-green-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">4 Bereiche, die Auditor*innen genau prüfen werden.</p>
          </div>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">6 Vorteile Ihrer ISO 27001 Zertifizierung.</p>
          </div>
            ...
            {BENEFITS_CERTIFIED.map((benefit) => {
              ...
              return (
                <div key={benefit.title} className="flex gap-4 bg-[#131927] border border-gray-800 rounded-xl p-6">
                  <div className="w-10 h-10 bg-green-600/10 border border-green-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Was Auditor*innen häufig finden – und wie man es behebt.</p>
          </div>
            ...
            {COMMON_FINDINGS.map((finding, i) => (
              <div key={i} className="bg-[#131927] border border-gray-800 rounded-xl p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className={`text-xs px-3 py-1 rounded-full font-semibold ${finding.severity === "Critical" ? "bg-red-600/20 text-red-400" : "bg-orange-600/20 text-orange-400"}`}>
                    {finding.severity}
                  </span>
                </div>
                <p className="text-gray-400 text-sm mb-2">
                  <span className="font-semibold text-gray-300">Lösung:</span> {finding.solution}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="bg-[#131927] border border-gray-800 rounded-xl p-6">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-br from-green-900/20 via-[#0d1117] to-[#0d1117] border-t border-gray-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a href={PHONE_HREF} className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white px-10 py-4 rounded-lg font-semibold transition-colors text-lg">
