...
const RTA_PHASES = [
  {
    ...
    desc: "Passive Aufklärung: Public Information sammeln, OSINT-Datenbanken durchsuchen, Mitarbeiter profilen.",
  },
  {
    step: "Phase 2",
  ...
  },
  {
    ...
    desc: "Tracks verwischen, Backdoors entfernen. Umfassendes Report: Was hätte ein echter Hacker getan?",
  },
];
...
const SCENARIOS = [
  ...
  },
  {
    ...
    desc: "Angriff über Third-Party: Vendor-Software kompromittieren, um ins Unternehmen zu kommen.",
  },
  {
  ...
  },
  {
    ...
    desc: "Mit Pretexting Mitarbeiter dazu bringen, Passwörter oder Zugänge zu verraten.",
  },
  {
    name: "Multi-Stage Attack",
    desc: "Kombinierte Angriffsvektoren: Initial Access → Privilege Escalation → Data Theft.",
  },
];
...
const RTA_VS_PENTEST = [
  ...
  {
    aspect: "Zeitraum",
    rta: "Wochen bis Monate – kontinuierliche Kampagne",
    pentest: "Tage bis 2 Wochen konzentriert",
  },
  {
    aspect: "Social Engineering",
    rta: "Zentral – Phishing, Pretexting, Manipulation",
    pentest: "Optional – meist nur technisch",
  },
  {
    aspect: "Ziel",
    rta: "Mission erfüllen (Daten stehlen, System lahmlegen)",
    pentest: "Schwachstellen finden & demonstrieren",
  },
  {
    aspect: "Realismus",
    rta: "Sehr realistisch – wie echte Cyberkriminelle",
    pentest: "Auch realistisch, aber begrenzte Scope",
  },
  {
    aspect: "Kosten",
    rta: "€15.000–€50.000+ (zeitaufwendig)",
    pentest: "€3.000–€15.000 (schneller)",
  },
];
...
const BENEFITS = [
  {
    ...
    desc: "Nicht: 'Was kann ein Hacker machen?' Sondern: 'Was würde ein echter Hacker machen – und kommen wir dagegen an?'",
  },
  {
    icon: AlertTriangle,
    title: "Ganzheitliche Sicherheit",
    desc: "Nicht nur Technologie, sondern auch Prozesse, Menschen, physische Sicherheit – alles wird geprüft.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    desc: "Red Team Report ist Beweis für Geschäftsführung: 'Das ist, was wir beheben müssen.'",
  },
  {
    icon: Zap,
    title: "True Business Impact",
    desc: "Nicht abstraktes Risiko, sondern: 'Hacker hätte Kundendaten für 48h stehlen können.'",
  },
];
...
const FAQS = [
  ...
  {
    q: "Können Sie auch Phishing durchführen?",
    a: "Ja – aber nur mit schriftlicher Genehmigung von der Geschäftsführung. Realistische Phishing-E-Mails sind Teil von RTA. Mitarbeiter werden aufgeklärt, dass es ein Test war.",
  },
  {
    q: "Wie wird sichergestellt, dass niemand Schaden nimmt?",
    a: "Ständige Kommunikation mit Incident Response Team. Wenn kritische Systeme erreicht: sofort stoppen & dokumentieren. RTA ist kontrolliert – nicht unkontrolliert.",
  },
  {
    q: "Was kostet ein Red Team Assessment?",
    a: "€15.000–€50.000+, abhängig von Dauer (1 Woche bis 3 Monate) und Komplexität. Je realistischer & umfassender, desto teurer.",
  },
  {
  ...
  },
  {
    ...
    a: "Ja – z.B. USB-Sticks im Parkplatz, tailgating ins Büro, Müll-Analyse (Dumpster Diving). Alles mit vorheriger Genehmigung.",
  },
];
    ...
    <main className="bg-[#0d1117] text-white min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#131927] via-[#0d1117] to-[#131927] py-20 lg:py-32 border-b border-gray-800 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="inline-flex items-center gap-2 bg-purple-600/10 border border-purple-600/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-purple-400 text-sm font-medium">Red Team Assessment · Realistisches Szenario · Enterprise Security</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/request-pentest" className="inline-flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors text-base">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[["50+", "Red Team Ops durchgeführt"], ["MITRE ATT&CK", "Based Methodology"], ["100%", "Realistisch"], ["Executive Ready", "Reports & Brief"]].map(([stat, label]) => (
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Die realistischste Form von Sicherheitstesting.</p>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Von OSINT bis Exfiltration.</p>
          </div>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Die Unterschiede auf einen Blick.</p>
          </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {RTA_VS_PENTEST.map((row, i) => (
                  <tr key={i} className="border-b border-gray-800 bg-[#131927] hover:bg-white/5">
                    <td className="px-4 py-3 font-semibold text-purple-400">{row.aspect}</td>
                    <td className="px-4 py-3 text-gray-300">{row.rta}</td>
                    <td className="px-4 py-3 text-gray-300">{row.pentest}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Realistisch Angriffsvektoren, die wir simulieren.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {SCENARIOS.map((scenario, i) => (
              <div key={i} className="bg-[#131927] border border-gray-800 rounded-xl p-5">
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Warum Unternehmen RTA durchführen sollten.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {BENEFITS.map((benefit) => {
              const Icon = benefit.icon;
              return (
                <div key={benefit.title} className="flex gap-4 bg-[#131927] border border-gray-800 rounded-xl p-6">
                  <div className="w-10 h-10 bg-purple-600/10 border border-purple-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-16 lg:py-20 bg-[#0a0e17]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">Durchschnitt über 50+ Red Team Assessments.</p>
          </div>
      ...
      <section className="py-10 bg-purple-900/10 border-y border-purple-800/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h3 className="text-lg font-bold mb-2">Red Team für Enterprise-Sicherheit</h3>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-10">Häufige Fragen zu Red Team Assessment</h2>
      ...
      <section className="py-14 bg-[#0a0e17]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-center mb-8">Red Team Assessment – Kosten</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[["2-Wochen Engagement", "€15.000–€25.000"], ["1-Monat Engagement", "€25.000–€40.000"], ["3-Monate Engagement", "€40.000–€75.000+"]].map(([type, price]) => (
          ...
          <div className="text-center mt-6 text-sm text-gray-500">
            *Custom-Preise für längere oder spezialisierte Engagements
          </div>
        </div>
      </section>

      {/* CTA */}
      <section className="py-20 bg-gradient-to-br from-purple-900/20 via-[#0d1117] to-[#0d1117] border-t border-gray-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Command className="w-14 h-14 text-purple-500 mx-auto mb-4" />
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">Red Team Assessment – Buchen Sie ein Konsult</h2>
          <p className="text-gray-400 text-lg mb-8">
            Realistische Angriffssimulation · MITRE ATT&CK-basiert · Executive Reporting · Multi-Phasen
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a href={PHONE_HREF} className="inline-flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-10 py-4 rounded-lg font-semibold transition-colors text-lg">
